...
public class GuiChanger extends GuiContainer
{
    ...
    public void initGui()
    {
        ...
        textBoxChangerName = new GuiTextField(fontRenderer, 0, 0, 100, 12);
    ...
    {
        fontRenderer.drawString(StatCollector.translateToLocal("container.mcmp1.Changer"), 8, 6, 0x404040);
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
    {
        ...
        int width = fontRenderer.getStringWidth(lblChangerName);
        fontRenderer.drawString(lblChangerName, var5 + 65 - width, var6 + 76, 0x404040);
        ObfuscationReflectionHelper.setPrivateValue(GuiTextField.class, this.textBoxChangerName, var5 + 68, "b", "xPos");
        ObfuscationReflectionHelper.setPrivateValue(GuiTextField.class, this.textBoxChangerName, var6 + 74, "c", "yPos");
