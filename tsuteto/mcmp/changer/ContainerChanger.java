...
public class ContainerChanger extends Container
{
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
    {
        ...
        if (var3 != null && var3.getHasStack())
        {
            ...
            {
            	if (var4.itemID == McmpMain.itemCassetteNormal.itemID)
            	{
            ...
            else if (var4.itemID != McmpMain.itemCassetteNormal.itemID || !this.mergeItemStack(var4, 0, this.numRows * 9, false))
            {
        		return null;
            }
