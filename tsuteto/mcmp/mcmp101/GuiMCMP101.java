...
public class GuiMCMP101 extends GuiContainer
{
        ...
        // Play
        {
            ...
            if (x >= 0 && y >= 0 && x < 30 && y < 16)
            {
                ...
                if (!controller.isPlaying)
                {
                    ...
                    {
                        controller.play(memory, entityPlayer, song);
                        ModLog.debug(Thread.currentThread().getName());
                        display = "PLAY";
                    }
                    else
                    {
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
    {
                ...
                && (ticksActionIndicator % 4 > 1 || ticksActionIndicator < 15))
        {
            ...
            {
                GuiUtilities.showLongString(display, ox + 14, oy + 12, displayWidth, Color.cyan.getRGB(), fontRenderer);
            }
            else
            {
                GuiUtilities.showLongString1Line(display, ox + 14, oy + 12, displayWidth, Color.cyan.getRGB(), fontRenderer);
            }
        }
    }
